...
public class BTRequestBuilder {
    ...
    public class func stbReq(request: BTSTBReq) -> String {
        //TODO: Implement a station board request
        return ""
    }
